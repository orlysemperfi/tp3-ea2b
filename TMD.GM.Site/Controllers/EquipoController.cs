...
namespace TMD.GM.Site.Controllers
{
    public class EquipoController : Controller
    {
        ...
        public ActionResult Registrar(string pCodiEqui, string pNombEqui, string pSerie, string pMarca, string pModel, string pCarac, string pFechaComp, string pFechaExpi, string pFechaUltiMant,
