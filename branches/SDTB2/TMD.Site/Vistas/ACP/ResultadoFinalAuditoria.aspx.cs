...
{
    public partial class ResultadoFinalAuditoria : System.Web.UI.Page
    {
        ...
        {
            List<Auditoria> lstAuditorias = TMD.Site.Controladora.ACP.AuditoriaControladora.ListarPlanAuditorias(DateTime.Today.Year, EstadoAuditoria.Planificado, EstadoAuditoria.Realizado);
            try
            {
        ...
        protected void gvAuditoria_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                Response.Redirect("ActResultadoFinalAuditoria.aspx?idAuditoria=" + sIdAuditoria, false);
            }
            catch (Exception ex)
            {
                lblError.ForeColor = System.Drawing.Color.Red;
