...
GO
INSERT [dbo].[PRIORIDAD] ([CODIGO], [NOMBRE]) VALUES (1, N'Baja')
INSERT [dbo].[PRIORIDAD] ([CODIGO], [NOMBRE]) VALUES (2, N'Media')
INSERT [dbo].[PRIORIDAD] ([CODIGO], [NOMBRE]) VALUES (3, N'Alta')
...
GO
/****** Object:  Table [dbo].[INFORME_CABECERA]    Script Date: 04/03/2013 12:26:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[INFORME_CABECERA](
	[NUMERO_INFORME] [int] NOT NULL,
	[FECHA_INFORME] [datetime] NULL,
	[CODIGO_EMPLEADO] [int] NULL,
	[OBSERVACION_EMPLEADO] [varchar](250) NULL,
 CONSTRAINT [PK_INFORME_CABECERA] PRIMARY KEY CLUSTERED 
(
	[NUMERO_INFORME] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
