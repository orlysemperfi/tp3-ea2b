...
( NAME = N'TMD', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.NERV\MSSQL\DATA\TMD.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB ), 
 FILEGROUP [TMD_fg_filestream] CONTAINS FILESTREAM  DEFAULT 
( NAME = N'TMD_filestream', FILENAME = N'C:\SqlFileStream\TMD_2.TMD_FS' )
 LOG ON 
( NAME = N'TMD_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.NERV\MSSQL\DATA\TMD_1.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
END
GO
