<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ActualizarHallazgo.aspx.cs" Inherits="TMD.ACP.Site.ActualizarHallazgo" EnableViewState="false" ValidateRequest="false" EnableEventValidation="false" %>
        ...
        <div id="divHallazgos" style="margin:10px 0px 0px 0px;height:100%;width:100%;">
          <asp:Repeater ID="rptHallazgos" runat="server" OnItemDataBound="rptHallazgos_ItemDataBound">
                    ...
                    <tr class="GridCab">                                      
                        ...
                        <td align="center" style="border-color:#E9E9E9;width:200px"><asp:Literal ID="litDescripcion" runat="server" Text="Pregunta"></asp:Literal></td>
                        <td align="center" style="border-color:#E9E9E9;width:50px"><asp:Literal ID="litTipoHallazgos" runat="server" Text="Tipo"></asp:Literal></td>                    
                        <td align="center" style="border-color:#E9E9E9;width:50px"><asp:Literal ID="litNdoc" runat="server" Text="N doc"></asp:Literal></td>                                            
                        <td align="center" style="border-color:#E9E9E9;width:200px"><asp:Literal ID="litDocumentos" runat="server" Text="Documentos"></asp:Literal></td>                    
                    ...
                    <tr class="RowStyle" id="ModoEdicionHallazgo<%# Eval("idHallazgo")%>" style="display:none">  
                         <td align="center" style="width:20px">                                                        
                            <asp:TextBox ID="txtIdHallazgo" runat="server" Text='<%# Eval("idHallazgo") %>' ReadOnly=true></asp:TextBox>                     
                         </td>   
                         <td align="left" style="width:200px">                                                            
                    ...
                    <FooterTemplate>                        
                        ...
                        <td align="left" style="width:200px">
                            <asp:TextBox ID="txtDesNewHallazgo" runat="server" Width="200" ></asp:TextBox>                      
                        </td>
