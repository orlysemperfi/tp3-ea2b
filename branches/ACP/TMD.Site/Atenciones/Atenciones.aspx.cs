...
namespace ServiceDesk.Atenciones
{
    public partial class Atenciones : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Selecciones/SeleccionarIntegrante.aspx");
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("~/Atenciones/NuevaAtencion.aspx?registro=M&nroticket=" + numeroTicket.ToString());
            }
        }
        ...
        protected void bntIngresarSolucion_Click(object sender, EventArgs e)
        {
            ...
            {
                numeroTicket = rowGrd.Cells[1].Text;
                Response.Redirect("~/Atenciones/IngresarSolucion.aspx?nroticket=" + numeroTicket.ToString());
            }
        }
        ...
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "RegisterStartupScript", "<script>serverCall('Invocara a la opción seguimiento')</script>");
        }
