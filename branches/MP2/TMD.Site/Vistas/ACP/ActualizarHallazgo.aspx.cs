...
namespace TMD.ACP.Site
{
    public partial class ActualizarHallazgo : BasePage
    {
        ...
        public void GrabarHallazgo()
        {
            ...
            //    int nIdOri = Convert.ToInt32(idHallazgo);
        ...
        public void QuitarHallazgo(string sId,string sIdAuditoria,string sIdPregunta)
        {            
            int idAuditoria = Convert.ToInt32(sIdAuditoria);
            int idPregunta = Convert.ToInt32(sIdPregunta);
            int idHallazgo = Convert.ToInt32(sId);
            TMD.Site.Controladora.ACP.HallazgoControladora.EliminarHallazgo(idHallazgo);
            ...
            var oFile = new ArchivoLogica();
            oFile.EliminarGrupoArchivos(idHallazgo, "H");
        }
