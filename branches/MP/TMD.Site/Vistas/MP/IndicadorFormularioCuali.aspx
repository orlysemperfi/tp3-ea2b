...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
                <asp:GridView ID="gwEscalasCuali" runat="server" AutoGenerateColumns="false"  DataSource='<%#ObtenerEscalaCualitativoListado() %>' OnRowEditing="GridView1_RowEditing" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting" AutoGenerateDeleteButton="true" AutoGenerateEditButton="true">
                    <Columns>
