...
namespace ServiceDesk.Seguimiento
{
    public partial class Atenciones : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Vistas/SD/Selecciones/SeleccionarIntegrante.aspx?seguimiento=s");
        ...
        protected void onEditarTicket()
        {
            ...
            else
            {
                ...
                Response.Redirect("~/Vistas/SD/Atenciones/NuevaAtencion.aspx?registro=M&nroticket=" + numeroTicket.ToString() + "&seguimiento=s");
            }
        }
        ...
        protected void onSolucionTicket()
        {
            ...
            {
                numeroTicket = rowGrd.Cells[1].Text;
                Response.Redirect("~/Vistas/SD/Atenciones/IngresarSolucion.aspx?nroticket=" + numeroTicket.ToString() + "&seguimiento=s");
            }
        }
        ...
        protected void onSeguimientoTicket()
        {
            ...
            else
            {
                ...
                Response.Redirect("~/Vistas/SD/Atenciones/IngresarSeguimiento.aspx?nroticket=" + numeroTicket.ToString() + "&seguimiento=s");
            }
        }
        ...
        protected void onAdjuntarDocumento()
        {
            ...
            else
            {
                ...
                Response.Redirect("~/Vistas/SD/Atenciones/AdjuntarDocumento.aspx?nroticket=" + numeroTicket.ToString() + "&seguimiento=s");
        ...
        protected void onCambioEstado()
        {
            ...
            else
            {
                ...
                Response.Redirect("~/Vistas/SD/Atenciones/CambiarEstado.aspx?nroticket=" + numeroTicket.ToString() + "&seguimiento=s");
        ...
        protected void onEscalarTicket()
        {
            ...
            else
            {
                ...
                Response.Redirect("~/Vistas/SD/Atenciones/EscalarTicket.aspx?nroticket=" + numeroTicket.ToString() + "&seguimiento=s");
