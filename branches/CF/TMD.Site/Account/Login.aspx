...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
            ...
            <div class="accountInfo">
                <fieldset class="login">
                    ...
                    <p>
                        ...
                        <asp:TextBox ID="UserName" runat="server" CssClass="textEntry" Width="221px"></asp:TextBox>
                    ...
                    <p>
                        ...
                        <asp:TextBox ID="Password" runat="server" CssClass="passwordEntry" TextMode="Password" Width="221px"></asp:TextBox>
    ...
    <asp:Image ID="imgPeople" EnableViewState="false" ImageUrl="~/Imagenes/peple.gif"
        runat="server" />
    </td>
    </tr>    
    </table>
