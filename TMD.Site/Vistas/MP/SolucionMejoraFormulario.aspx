                                ...
                                <td>
                                    <fieldset>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="padding-bottom:10px;">
                                                    <asp:GridView ID="gvwAcciones" runat="server" AutoGenerateColumns="false" AllowPaging="false" Width="760px" BorderWidth="0px" BorderColor="White" DataSource='<%#ObtenerAccionesListado() %>' OnRowEditing="gvwAcciones_RowEditing" OnRowCancelingEdit="gvwAcciones_RowCancelingEdit" OnRowUpdating="gvwAcciones_RowUpdating" OnRowDeleting="gvwAcciones_RowDeleting" AutoGenerateDeleteButton="true" AutoGenerateEditButton="true">
                                                        <Columns>
